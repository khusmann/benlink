...
class DeviceManagementServicer:
    ...
    def CheckFirmwareUpdate(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_DeviceManagementServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'benshikj.DeviceManagement', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('benshikj.DeviceManagement', rpc_method_handlers)
